...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'third-eye.com'
  config.app_name = 'Third_eye'
  config.mailer.from = 'Third_eye <no-reply@third-eye.com>'
  ...
  #
  config.app_secret = '0df6O42_dKYr8Z59F3JrcTZX2DK4K8LK74BwRVLmubsOwNwWFzmjk9x4ufWzTbsn0NU'
